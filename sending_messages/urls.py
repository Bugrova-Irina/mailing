...
from sending_messages.views import (
    ...
    MailingDeleteView,
    MailingDetailView,
    MailingListRecipientCreateView,
    MailingListRecipientDeleteView,
    MailingListRecipientDetailView,
    MailingListRecipientListView,
    MailingListRecipientUpdateView,
    MailingListView,
    MailingUpdateView,
    MainPageView,
)
...
urlpatterns = [
    ...
    path(
        "recipients/<int:pk>/",
        MailingListRecipientDetailView.as_view(),
        name="recipient_detail",
    ),
    path(
        "recipients/create/",
        MailingListRecipientCreateView.as_view(),
        name="recipient_create",
    ),
    path(
        "recipients/<int:pk>/update/",
        MailingListRecipientUpdateView.as_view(),
        name="recipient_update",
    ),
    path(
        "recipients/<int:pk>/delete/",
        MailingListRecipientDeleteView.as_view(),
